...
class PartiallyMappedCrossOver(CrossOver):
    ...
    def _crossover(
        ...
        self._fill_missing_values(child1, parent2, point1, point2)
        self._fill_missing_values(child2, parent1, point1, point2)
        return child1, child2

    def _fill_missing_values(
        self, child: torch.Tensor, parent: torch.Tensor, point1: int, point2: int
    ) -> None:
